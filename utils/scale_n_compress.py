...
input_dir = r"C:\Users\temir\Documents\KULcourses\Thesis_CV\code_yolo8_base\y8\yolo_tracking\COCO_AND_CUSTOM\yolo\ORIGINAL\obj_TEST_data-large"
output_dir = r"C:\Users\temir\Documents\KULcourses\Thesis_CV\code_yolo8_base\y8\yolo_tracking\COCO_AND_CUSTOM\yolo\test_data_output"
...
# Compression quality level (1-100): Lower value means higher compression and lower quality
compression_quality = 100

# Iterate over all PNG files in the input directory
for i in range(5358):  # Updated range to include files from 000000 to 005357
    ...
    # Compress the resized image with specified quality
    ...
    print(f"Processed and compressed {img_file} and {txt_file} with quality {compression_quality}")

print("All images and annotations have been resized, compressed, and saved.")
